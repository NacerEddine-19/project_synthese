...
import { gsapAnimation } from './gsap.notFoundPage';
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 align-self-center">
                            <svg className='svg' version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
                                viewBox="0 0 800 600">
                                <g>
                                    <defs>
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z" />
					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				" />
                        ...
                        <div className="col-md-6 align-self-center">
                            ...
                            <p className='p'>The page you are looking for does not exist.
                                How you got here is a mystery. But you can click the button below
                                to go back to the homepage.
                            </p>
                            <button onClick={handleClick} className="btn green">HOME</button>
                        </div>
                    </div>
                </div>
            </main>
